...
# Public release script derived from: 2\细菌热图.txt
...
# === 读取细菌数据 ===
dt <- read.csv(public_file("3-17", "4细菌热图.csv"), 
...
# === 输出 PDF ===
pdf(public_output("PCoA_Bacteria_Heatmap.pdf"), width = 14, height = 10)
draw(main_heatmap, annotation_legend_side = "right", heatmap_legend_side = "right")
dev.off()
